...
namespace EcommerceAdmin.Models.Sistema
{
    public class DBMysql : IDisposable
    {
        ...
        public DBMysql()
        {
            ...
            this.Database = ConfigurationManager.AppSettings["MysqlDatabase"].ToString();
            this.Username = ConfigurationManager.AppSettings["MysqlUsername"].ToString();
            this.Password = ConfigurationManager.AppSettings["MysqlPassword"].ToString();
            this.Port = ConfigurationManager.AppSettings["MysqlPort"].ToString();
        }
